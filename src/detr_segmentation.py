...
def plot_results(pil_img, prob, boxes, f_n):
    ...
    plt.axis('off')
    plt.savefig("../segmentation_results/detr/frame"+str(frame_number)+".jpg")
...
while True:
    ...
    plot_results(im, probas[keep], bboxes_scaled, frame_number)
